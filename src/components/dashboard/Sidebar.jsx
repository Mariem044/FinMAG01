        ...
        children: [
            ...
            children: [
              _jsxs("div", {
                children: [
                  _jsx("h1", {
                    className:
                      "text-[22px] leading-none font-extrabold text-foreground tracking-tight",
                    children: "SIAD",
                  }),
                  _jsx("p", {
                    className:
                      "text-[10px] text-text-dim font-semibold tracking-[0.18em] uppercase mt-1",
                    children: "MAG Distribution BI",
                  }),
                ],
              }),
              _jsxs("button", {
          ...
          _jsxs("nav", {
            ...
            children: [
              _jsx("p", {
                className:
                  "text-[10px] font-semibold text-text-dim uppercase tracking-widest px-3 mb-2",
                children: "Navigation",
              }),
              navItems.map((item) => {
                ...
                `,
                    children: [
                      ...
                      active &&
                        _jsx("span", {
                          className:
                            "ml-auto w-1.5 h-1.5 rounded-full bg-primary shadow-[0_0_8px_rgba(59,130,246,0.7)]",
                        }),
                    ],
                  },
                  item.to,
          ...
          _jsxs("div", {
            className: "border-t border-border px-3 py-3 space-y-0.5",
            children: [
              _jsxs("button", {
                className:
                  "flex items-center gap-3 px-3 py-2.5 rounded-lg text-[13px] text-text-muted hover:bg-surface-hover hover:text-foreground w-full transition-colors border border-transparent",
                children: [
                  _jsx(Settings, { size: 16, className: "text-text-dim flex-shrink-0" }),
                  "Param\u00E8tres",
                ],
              }),
              _jsxs("button", {
                className:
                  "flex items-center gap-3 px-3 py-2.5 rounded-lg text-[13px] text-text-muted hover:bg-surface-hover hover:text-foreground w-full transition-colors border border-transparent",
                children: [
                  _jsx(HelpCircle, { size: 16, className: "text-text-dim flex-shrink-0" }),
                  "Aide",
                ],
              }),
              _jsx("p", { className: "text-[10px] text-[#444] px-3 pt-1", children: "v1.0.0" }),
            ],
          }),
        ],
      }),
